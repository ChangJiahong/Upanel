    ...
    public class Hook
    {
        ...
        public bool InstallHook()
        {
            ...
            if (this.m_pKeyboardHook == IntPtr.Zero)
            {
                ...
                this.m_pKeyboardHook = SetWindowsHookEx(idHook, m_KeyboardHookProcedure, (IntPtr)GetModuleHandle(Process.GetCurrentProcess().MainModule.ModuleName), 0);
                if (this.m_pKeyboardHook == IntPtr.Zero)
                {
                    this.UnInstallHook();
                    return false;
